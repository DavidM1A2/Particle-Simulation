...
public class ParticleEnvironment extends PApplet
{
	...
	public void keyPressed()
	{
		...
		{
			this.particleSystem.addWall(this.mouseX, this.mouseY, 400, 400); //this.random(50, 100), this.random(50, 100));
		}
